...
app.post('/api/connectSubject', (req, res) => {
    pool.getConnection(function(err, connection) {
        ...
        connection.query("INSERT INTO subjects_teachers (subject_id, teacher_id, days) VALUE (?, ?, ?)", [req.body.subject.id, req.body.teacher.id, req.body.subject.days], function(error, result, fields) {
            connection.release();
